        ...
        <div class="main"><div class="sec1">
            ...
            <div className="carousel-text">
                ...
                <div className="sec1-btn">
                    <button className="button-17" role="button">Yes!</button>
                    <button className="button-18" role="button">I like overpaying</button>
                </div>
            </div>
                            ...
                            <div>
                                <div className="sc-ee301021-6">
                                    ...
                                    <div className="sc-ee301021-9">
                                        See <a href="/terms">Terms</a> for details.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="grid-container">
                    <div class="grid-item">
                        <div class="sc-c5eaa547-0">
                                    ...
                                    <div class="sc-847ff752-0">
                                        <span
                                            style={{
                                                ...
                                                alt="" aria-label="" data-testid="productCard_image" src={tomato}
                                                decoding="async" data-nimg="fixed" class="sc-847ff752-1 iPJfJT"
                                                style={{
                                                    backgroundColor: '#faf3ef',
                                                    position: 'absolute',
                                                    inset: '0px',
                            ...
                            <div class="sc-c5eaa547-1">Save 30%</div>
                            <div class="sc-c5eaa547-2">₹4.19</div>
                            <div class="sc-c5eaa547-3">₹5.99 MRP</div>
                            <div class="sc-c5eaa547-4">Tomatoes</div>
                        </div>
                    </div>
                    <div class="grid-item">
                        <div class="sc-c5eaa547-0">
                            <div class="fresnel-container fresnel-lessThan-lg ">
                                <div class="sc-e0e305e2-0">
                                    <div class="sc-847ff752-0">
                                        <span
                                            style={{
                                                ...
                                                alt="" aria-label="" data-testid="productCard_image"
                                                src={carrot} decoding="async" data-nimg="fixed"
                                                class="sc-847ff752-1 iPJfJT"
                                                style={{
                                                    backgroundColor: '#faf3ef',
                                                    position: 'absolute',
                                                    inset: '0px',
                                    ...
                                    <div class="sc-e0e305e2-1"></div>
                                </div>
                            </div>
                            <div class="fresnel-greaterThan-md "></div>
                            <div class="sc-c5eaa547-1">Save 30%</div>
                            <div class="sc-c5eaa547-2">₹4.19</div>
                            <div class="sc-c5eaa547-3">₹5.99 MRP</div>
                            <div class="sc-c5eaa547-4">Carrots</div>
                        </div>
                    </div>
                    <div class="grid-item">
                        <div class="sc-c5eaa547-0">
                            ...
                            <div class="sc-c5eaa547-2">₹4.19</div>
                            <div class="sc-c5eaa547-3">₹5.99 MRP</div>
                            <div class="sc-c5eaa547-4">Potato</div>
                        </div>
                    </div>
                    <div class="grid-item">
                        <div class="sc-c5eaa547-0">
                            ...
                            <div class="sc-c5eaa547-2">₹4.19</div>
                            <div class="sc-c5eaa547-3">₹5.99 MRP</div>
                            <div class="sc-c5eaa547-4">Broccoli</div>
                        </div>
                    </div>
                </div>
                <div class="div-but25">
                    <button class="button-25" role="button">Start
                        Shopping</button>
                </div>
            </div>
            ...
            <div class="sec4">
                <div>
                    ...
                    <div class="div-but26">
                        <button class="button-26" role="button">Get
                            Started</button>
                    </div>
                </div>
            </div>
            ...
            <div class="sec5">
                <div class="grid-container">
                    ...
                    <div class="grid-item1">
                        ...
                        <div class="but-x">
                            <a class="sc-232424a1-0">Start Saving<svg width="13" height="13" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="sc-iBzEeX">
                                <path
